# DRAFT - Angular Boot Camp Curriculum - observables
...
[StackBlitz for observables](https://stackblitz.io/github/AngularBootCamp/observables)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/observables.git
cd observables
yarn
yarn start
```
